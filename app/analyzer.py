...
# Pipeline principal : orchestre analyses faciale, vocale, transcription,
# Q/R et sincérité, retourne un dict complet des résultats
def analyze_video(
    video_path: str,
    question: str = None,
    response: str = None,
    ...
    Args:
        ...
        start_time  : Début du segment à analyser pour la sincérité (en s).
        end_time    : Fin du segment à analyser pour la sincérité (en s).
    ...
    # puis on appelle get_top_emotion_frames UNE FOIS sur la liste.
    emotion_results = []
